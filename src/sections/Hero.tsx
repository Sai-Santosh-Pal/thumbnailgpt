    ...
    <div className="container">
      <div className='md:flex item-center'>
        <div className='md:w-[478px]'>
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#0e3cd3] text-transparent bg-clip-text mt-6">
        ...
        <div className='mt-20 md:mt-[-50px] md:h-[648px] md:flex-1 relative'>
          ...
          <Image 
            ...
            height={220}
            alt="Cylinder Image"
            className='hidden md:block -top-8 -left-20 md:absolute'></Image>
            <Image
            alt = "Noodle Image"
            src={noodleImage} 
            width={220} 
